...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-9">
            <form class="form-horizontal" action="{{route('countries.update')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="season_start" class="form-control" value="{{$coutry->season_start}}>
                </div>
                <div class="form-group">
                    <label for="season_end">Season ends</label>
                    <input type="text" name="season_end" class="form-control" value="{{$coutry->season_end}}>
                </div>
